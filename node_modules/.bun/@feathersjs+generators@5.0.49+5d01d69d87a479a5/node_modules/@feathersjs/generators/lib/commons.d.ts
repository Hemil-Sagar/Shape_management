 ...
 */
export declare const addVersions: (dependencies: string[], versions: DependencyVersions, defaultVersion?: string) => string[];
/**
 ...
 */
export declare class FeathersGeneratorError extends Error {
    /**
