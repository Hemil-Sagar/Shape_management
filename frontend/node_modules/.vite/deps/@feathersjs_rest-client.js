import {
  require_lib
} from "./chunk-LRG7OMZ6.js";
import {
  require_lib as require_lib3
} from "./chunk-GAMJPFNC.js";
import {
  require_lib as require_lib2
} from "./chunk-YG6P6GTA.js";
import {
  __commonJS
...
var require_base = __commonJS({
  "node_modules/@feathersjs/rest-client/lib/base.js"(exports) {
    "use strict";
    ...
    exports.Base = void 0;
    var qs_1 = __importDefault(require_lib4());
    ...
    var Base = class {
      ...
      _get(id, params) {
        if (id === void 0 || id === "") {
          return Promise.reject(new errors_1.BadRequest("id for .get is required"));
        }
        return this.request({
      ...
      _update(id, data, params) {
        if (id === void 0 || id === "") {
          return Promise.reject(new errors_1.BadRequest("id for .update is required"));
        }
        return this.request({
          url: this.makeUrl(params.query, id, params.route),
          body: data,
      ...
      _patch(id, data, params) {
        if (id === void 0 || id === "") {
          return Promise.reject(new errors_1.BadRequest("id for .patch is required"));
        }
        return this.request({
          url: this.makeUrl(params.query, id, params.route),
          body: data,
      ...
      _remove(id, params) {
        if (id === void 0 || id === "") {
          return Promise.reject(new errors_1.BadRequest("id for .remove is required"));
        }
        return this.request({
          url: this.makeUrl(params.query, id, params.route),
          method: "DELETE",
...
var require_axios = __commonJS({
  "node_modules/@feathersjs/rest-client/lib/axios.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.AxiosClient = void 0;
    var base_1 = require_base();
    var AxiosClient = class extends base_1.Base {
...
var require_fetch = __commonJS({
  "node_modules/@feathersjs/rest-client/lib/fetch.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.FetchClient = void 0;
    var errors_1 = require_lib();
    var base_1 = require_base();
    var FetchClient = class extends base_1.Base {
      request(options, params) {
        ...
        return this.connection(options.url, fetchOptions).then(this.checkStatus).then((response) => {
...
var require_superagent = __commonJS({
  "node_modules/@feathersjs/rest-client/lib/superagent.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SuperagentClient = void 0;
    var base_1 = require_base();
    var SuperagentClient = class extends base_1.Base {
      request(options, params) {
...
var require_lib5 = __commonJS({
  "node_modules/@feathersjs/rest-client/lib/index.js"(exports, module) {
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Object.defineProperty(exports, "AxiosClient", { enumerable: true, get: function() {
      return axios_1.AxiosClient;
    } });
    var fetch_1 = require_fetch();
    Object.defineProperty(exports, "FetchClient", { enumerable: true, get: function() {
      return fetch_1.FetchClient;
    } });
    var superagent_1 = require_superagent();
    Object.defineProperty(exports, "SuperagentClient", { enumerable: true, get: function() {
...
//# sourceMappingURL=@feathersjs_rest-client.js.map
